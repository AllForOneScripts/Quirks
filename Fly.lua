...
local function cleanupMotors(root, preserveVelY)
    ...
    -- FIX: Restaurar completamente el estado del Humanoid para evitar TPs de desincronización
...
local function startParticleEmitter()
    ...
    flyanim.particleConn = task.spawn(function()
        -- FIX: Añadida la comprobación del string de modo en el bucle principal
